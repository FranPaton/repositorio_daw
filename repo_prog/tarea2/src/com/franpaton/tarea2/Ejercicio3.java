...
public class Ejercicio3 {
	...
	public static void main(String[] args) {
		...
		do {
			...
			if(!entrada.hasNextInt()) {			//antes de guardar el contenido del scanner, se comprueba que es un número entero.
				...
				if (opcionMenu == 0) {
					System.out.println("Programa terminado. Pulse Enter para continuar.");
					entrada.nextLine();
					
					
				}else if (opcionMenu >= 0 && opcionMenu <= 5) { 		//se comprueba que la opcion escogida está entre 1 y 6
					switch(opcionMenu) {
						case 1:  // SUMAR
							System.out.println("Introduce primer número: ");
							if(entrada.hasNextInt()) {				// se comprueba que num1 es un número entero
								num1 = entrada.nextInt();
								System.out.println("Introduce segundo número:");  
								if (entrada.hasNextInt()) {			//se comprueba que num2 es un número entero
									num2 = entrada.nextInt();
									System.out.println("Resultado: " + num1 + " + " + num2 + " = " + (num1 + num2));
								
								} else {
									System.out.println("Error, no has introducido un número correcto.");
									entrada.next();
								}
		...
		} while ((opcionMenu >=1 && opcionMenu <=6) || opcionMenu !=0);
